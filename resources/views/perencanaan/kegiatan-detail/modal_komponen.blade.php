            ...
            <div class="modal-body px-lg-10">
                ...
                <div class="row">
                    <div class="form-group col-lg-6">
                        ...
                        {!! Form::select('modal_perkiraan', $perkiraan, null, ['class'=>'form-control form-select-modal-solid modal-select2', 'data-control'=>'select2', 'id'=>'modal_perkiraan']) !!}
                    </div>
                    <div class="form-group col-lg-6">
                        <label class="form-label">Komponen</label>
                        {!! Form::select('modal_komponen', $komponen, null, ['class'=>'form-control form-select-modal-solid modal-select2', 'data-control'=>'select2', 'id'=>'modal_komponen'], $opt_komponen) !!}
                    </div>
                    <div class="form-group col-lg-6">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        {!! Form::text('modal_keterangan', "", ['class'=>'form-control modal-text', 'id'=>'modal_keterangan']) !!}
                    </div>
                </div>
            </div>
            <!--end::Modal body-->
