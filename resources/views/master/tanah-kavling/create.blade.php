                ...
                <div class="card-body">
                    ...
                    @if (empty($data))
                        <div class="row">
                            ...
                            <div class="fv-row form-group col-lg-6 mb-3">
                                ...
                                {!! Form::text('letak', null, ['class'=>'form-control', 'id'=>'letak', 'autocomplete'=>'off']) !!}
                            </div>
                    ...
                    @else
                        <div class="row">
                            <div class="fv-row form-group col-lg-6 mb-3">
                                <label class="form-label">Nama</label>
                                {!! Form::text('nama', null, ['class'=>'form-control', 'id'=>'nama', 'autocomplete'=>'off', 'readonly']) !!}
                            </div>

                            <div class="fv-row form-group col-lg-6 mb-3">
                                <label class="form-label">Lokasi</label>
                                <input type="text" class="form-control" value="{{ $data->kode_kavling.' - '.$data->letak }}" readonly="">
                            </div>
