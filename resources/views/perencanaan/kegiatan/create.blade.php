...
<div id="kt_content_container" class="container-xxl">
    ...
    <div class="row g-5 g-xl-8">
        ...
        <div class="col-12 mb-md-5 mb-xl-10">
            @if (isset($data))
                {!! Form::model($data, ['route' => ['perencanaan.kegiatan.update', $data->id], 'class' => 'form', 'id' => "form-kegiatan",]) !!}
            ...
            <div class="card shadow-sm">
                <div class="card-header">
                    <h3 class="card-title">@if (isset($data))Edit @else Tambah @endif Kegiatan</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="fv-row form-group col-lg-6 mb-3">
                            ...
                            {!! Form::select('program_id', $program, null, ['class'=>'form-control form-select-solid', 'data-control'=>'select2', 'id'=>'program']) !!}
                        </div>
                        <div class="fv-row form-group col-lg-6 mb-3">
                ...
                <div class="card-footer" style="text-align: right;">
                    <a href="{{ route('perencanaan.kegiatan.index') }}" class="btn btn-light btn-active-light-primary me-2">Kembali</a>
